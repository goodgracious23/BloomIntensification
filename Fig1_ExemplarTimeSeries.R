...
pdf(file=here("fig2_trend_histogram.pdf"), height=5, width=6.5)
...
legend("top", legend=c("Intensity", "Severity", "Duration"), col=c(intensecol, severitycol, durationcol), lwd=3, ncol=3, bty="n")
