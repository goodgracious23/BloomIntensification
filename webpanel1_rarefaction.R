## ----------------------------------------------------------------------------
## Apply rarefaction analysis to a number of lake years (n = 32 lake years)
## Script written by Jon Walter - last updated 22 August 2020 by GM Wilkinson
...
# ## Mendota, 2014
# mendota2014<-mendota.raw[mendota.raw$year4==2014,]
# mendota2014<-aggregate(mendota2014$chlor, list(mendota2014$daynum), FUN="mean")
# colnames(mendota2014)<-c("daynum","chlor")
# 
# rf.mendota2014<-rarefy(tt=mendota2014$daynum, ts=mendota2014$chlor)
# 
# plot(mendota2014$daynum,mendota2014$chlor,ylab="chl",xlab="DOY")
# plot(rf.mendota2014$interval,rf.mendota2014$dat.mean,xlim=c(1,30), ylab="mean chl", xlab="sampling interval")
# abline(v=c(7,14), col="grey")
# plot(rf.mendota2014$interval,rf.mendota2014$dat.max,xlim=c(1,30), ylab="max chl", xlab="sampling interval")
# abline(v=c(7,14), col="grey")
# plot(rf.mendota2014$interval,rf.mendota2014$dat.maxdate,xlim=c(1,30),ylab="day of max", xlab="sampling interval")
# abline(v=c(7,14), col="grey")
# plot(rf.mendota2014$interval,rf.mendota2014$dat.95pct,ylab="95%",xlab="sampling interval")
# abline(v=c(7,14), col="grey")
# plot(rf.mendota2014$interval,rf.mendota2014$dat.grtr,ylab="p > 11",xlab="sampling interval")
# abline(v=c(7,14), col="grey")
# plot(rf.mendota2014$interval,rf.mendota2014$dat.var,ylab="variance",xlab="sampling interval")
# abline(v=c(7,14),col="grey")
# mtext("Mendota, 2014", 3, outer=T, line=-0.5)
...
intensecol <- rgb(82,139,139, max = 255, alpha = 75)
intensecol1 <- rgb(82,139,139, max = 255, alpha = 250)
severitycol <- rgb(16,78,139, max = 255, alpha = 75)
severitycol1 <- rgb(16,78,139, max = 255, alpha = 220)
durationcol <- rgb(102,102,102, max = 255, alpha = 75)
...
lines(1:30,apply(rmseratio.mean,2,median,na.rm=T),lwd=3, col=intensecol1)
mtext("Magnitude (Mean Annual Chlorophyll)",3,cex=0.7)
...
lines(1:30,apply(rmseratio.95pct,2,median,na.rm=T),lwd=3, col=severitycol1)
...
lines(1:30,apply(rmseratio.grtr,2,median,na.rm=T),lwd=3, col=durationcol1)
